...
interface HomeClientProps {
  ...
  initialCabinCount: number | null;
  initialSuccessStories: SuccessStoryItem[];
  initialFaqs: FAQItem[];
}
...
/* ─────────────────────────────────────────────
   ...
   ───────────────────────────────────────────── */
function FAQSection({ initialFaqs }: { initialFaqs: FAQItem[] }) {
  const faqs = initialFaqs.length > 0 ? initialFaqs : faqFallback;
...
export default function HomeClient({
  ...
  const cabinCount = initialCabinCount;
  const successStories = initialSuccessStories;
  ...
  const competitiveCourses = otherDepts
    .flatMap((dept) =>
  ...
  const faqSchema = {
    ...
    '@type': 'FAQPage',
    mainEntity: initialFaqs.length > 0
      ? initialFaqs.map((faq) => ({
          '@type': 'Question',
          name: faq.question,
          acceptedAnswer: {
  ...
  return (
    <PublicLayout>
      ...
      <section className="py-20 sm:py-28 bg-white dark:bg-gray-900">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="mt-3 text-gray-550 dark:text-gray-400 max-w-xl mx-auto text-lg">
      ...
      {/* Wave: Achievements (dark) → AI Study Tips (light) */}
      <WaveDivider type="wave" fillLight="#ffffff" fillDark="#111827" />
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
              {computerDept.courses.slice(0, 6).map((course) => (
                <div key={course.id} className="group bg-white/5 border border-white/10 border-l-4 border-l-cyan-500 rounded-2xl p-5 hover:bg-cyan-50/5 dark:hover:bg-cyan-950/30 hover:border-cyan-500/30 transition-all duration-300 cursor-pointer" onClick={() => openCourseModal(course, computerDept.name)}>
                  ...
                  {course.description && (
                    <p className="text-sm text-gray-400 line-clamp-2 mb-4 leading-relaxed">{course.description}</p>
                  )}
        ...
        <section className="py-20 sm:py-28">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-14">
              ...
              <p className="mt-3 text-gray-550 max-w-xl mx-auto text-lg">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
              {competitiveCourses.map((course) => (
                <Card key={course.id} className="border border-gray-100 rounded-2xl hover:border-blue-200 hover:shadow-lg hover:shadow-blue-50 transition-all duration-300 group overflow-hidden cursor-pointer" onClick={() => openCourseModal(course, course.departmentName)}>
                  ...
                  <CardContent className="p-5">
                    ...
                    {course.description && (
                      <p className="mt-2 text-sm text-gray-500 line-clamp-2 leading-relaxed">{course.description}</p>
                    )}
      ...
      {/* Wave: Why Choose Us (light) → Success Stories (dark) */}
      <WaveDivider type="wave" fillLight="#030712" fillDark="#030712" flip />
      ...
      {/* ============================================
          ...
          ============================================ */}
      <ScrollReveal>
        <SuccessStoriesSection initialStories={successStories} />
      </ScrollReveal>
          ...
          <div className="cta-border-glow rounded-3xl cta-glow-shadow bg-gray-950 p-10 sm:p-14">
            ...
            <div className="mt-10 flex flex-wrap justify-center gap-6 text-sm text-gray-500">
              {siteSettings.businessPhone ? (
                <a href={`tel:${siteSettings.businessPhone}`} className="flex items-center gap-2 hover:text-cyan-400 transition-colors animate-pulse-subtle">
