...
const achievements = [
  {
    ...
    title: 'SSC CGL 2024',
    description: '12 students selected in SSC CGL 2024 from our coaching program. Highest score: 178/200 in Tier-I.',
  ...
  },
  {
    ...
    title: 'NIELIT CCC',
    description: '100% pass rate in NIELIT CCC exam. Average score: 82%. Our students consistently outperform national averages.',
    barColor: 'from-cyan-500 to-sky-400',
  },
  {
    badge: 'Banking',
    badgeColor: 'bg-blue-500/10 text-blue-400 border-blue-500/20',
    title: 'Banking Exams 2024',
    description: '8 students cleared IBPS PO and SBI Clerk exams. Combined success rate: 85% for dedicated students.',
